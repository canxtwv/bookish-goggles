...
import com.affine.TwitterDemo.entity._
import com.affine.TwitterDemo.entity.TwitterdemoEntityDatabase
...
object TwitterdemoServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new TwitterdemoService(serviceIdentity, producer, untypedSystem, new TwitterdemoEntityDatabase(context.system, producer))
  ...
  val system = akka.actor.ActorSystem("twitterdemo")
